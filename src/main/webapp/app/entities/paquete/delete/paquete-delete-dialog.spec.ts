...
import { PaqueteDeleteDialog } from './paquete-delete-dialog';

describe('Paquete Management Delete Component', () => {
  let comp: PaqueteDeleteDialog;
  let fixture: ComponentFixture<PaqueteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PaqueteDeleteDialog);
