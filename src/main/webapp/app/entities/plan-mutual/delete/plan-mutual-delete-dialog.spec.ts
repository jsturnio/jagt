...
import { PlanMutualDeleteDialog } from './plan-mutual-delete-dialog';

describe('PlanMutual Management Delete Component', () => {
  let comp: PlanMutualDeleteDialog;
  let fixture: ComponentFixture<PlanMutualDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlanMutualDeleteDialog);
