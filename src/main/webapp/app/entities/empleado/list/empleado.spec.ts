...
describe('Empleado Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 11214 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to empleadoService', () => {
      ...
      vi.spyOn(service, 'getEmpleadoIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.empleadosParams()).toMatchObject({ sort: ['id,desc'] });
  });
