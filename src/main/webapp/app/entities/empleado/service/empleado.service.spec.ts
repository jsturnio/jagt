...
describe('Empleado Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Empleado', () => {
      ...
      service.create(empleado).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Empleado', () => {
      ...
      service.update(empleado).subscribe(resp => (expectedResult = resp));
    ...
    describe('addEmpleadoToCollectionIfMissing', () => {
      it('should add a Empleado to an empty array', () => {
        ...
        expect(expectedResult).toEqual([empleado]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([empleado, empleado2]);
      });
