...
import { BioquimicoDeleteDialog } from './bioquimico-delete-dialog';

describe('Bioquimico Management Delete Component', () => {
  let comp: BioquimicoDeleteDialog;
  let fixture: ComponentFixture<BioquimicoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BioquimicoDeleteDialog);
