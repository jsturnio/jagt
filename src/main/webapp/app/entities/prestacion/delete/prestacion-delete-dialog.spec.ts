...
import { PrestacionDeleteDialog } from './prestacion-delete-dialog';

describe('Prestacion Management Delete Component', () => {
  let comp: PrestacionDeleteDialog;
  let fixture: ComponentFixture<PrestacionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PrestacionDeleteDialog);
