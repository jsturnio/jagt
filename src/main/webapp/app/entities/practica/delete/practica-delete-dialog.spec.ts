...
import { PracticaDeleteDialog } from './practica-delete-dialog';

describe('Practica Management Delete Component', () => {
  let comp: PracticaDeleteDialog;
  let fixture: ComponentFixture<PracticaDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PracticaDeleteDialog);
