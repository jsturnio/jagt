...
import { sampleWithRequiredData } from '../practica.test-samples';
...
describe('Practica Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 7449 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to practicaService', () => {
      ...
      vi.spyOn(service, 'getPracticaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPracticaIdentifier).toHaveBeenCalledWith(entity);
