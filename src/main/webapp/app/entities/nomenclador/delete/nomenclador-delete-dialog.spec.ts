...
import { NomencladorDeleteDialog } from './nomenclador-delete-dialog';

describe('Nomenclador Management Delete Component', () => {
  let comp: NomencladorDeleteDialog;
  let fixture: ComponentFixture<NomencladorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(NomencladorDeleteDialog);
