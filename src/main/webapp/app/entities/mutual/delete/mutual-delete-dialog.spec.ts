...
import { MutualDeleteDialog } from './mutual-delete-dialog';

describe('Mutual Management Delete Component', () => {
  let comp: MutualDeleteDialog;
  let fixture: ComponentFixture<MutualDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MutualDeleteDialog);
