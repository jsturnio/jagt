export const AG_GRID_LOCALE_ES = {
  ...
  formulaParseMismatchedParenthesesOrUnfinishedFunctionCall: 'Paréntesis no coinciden o llamada de función sin terminar.',
  ...
  formulaSerializeCannotProduceAbsoluteColumnLabelFromId: "No se puede generar etiqueta absoluta de COLUMNA desde el id '${variable}'.",
  formulaSerializeCannotProduceAbsoluteRowIndexFromId: "No se puede generar índice absoluto de FILA desde el id '${variable}'.",
  ...
  ariaLabelAdvancedFilterBuilderJoinSelectField: 'Campo de selección de operador de unión del generador de filtro avanzado',
  ...
  and: 'Y',
  OR: 'O',
  pageSizeComp: 'tamaño de página',
  itemsPerPage: 'Elementos por página',
  pageSizeButtonText: 'Tamaño de página3',
  paginationPageSize: 'Tamaño de página4',
  groupBy: 'Agrupar por',
  groupRemove: 'Quitar de grupo',
  columns: 'Columnas',
  filters: 'Filtros',
  ...
  valueColumnsEmptyMessage: 'Arrastra columnas aquí para agregar valores',
  pivotMode: 'Modo pivot',
  groups: 'Grupos',
  values: 'Valores',
  pivots: 'Pivotes',
  pivotColumns: 'Columnas pivot',
  pivotColumnsEmptyMessage: 'Arrastra columnas aquí para pivotear',
